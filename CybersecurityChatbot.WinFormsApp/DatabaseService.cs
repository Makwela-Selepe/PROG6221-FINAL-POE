...
namespace CybersecurityChatbot.WinFormsApp
{
    public class DatabaseService
    {
        private readonly string serverConnectionString =
            "server=127.0.0.1;port=3306;user=root;password=CyberPass123!;SslMode=None;";

        private readonly string databaseConnectionString =
            "server=127.0.0.1;port=3306;database=cybersecurity_chatbot_db;user=root;password=CyberPass123!;SslMode=None;";

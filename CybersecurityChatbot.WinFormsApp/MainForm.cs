    ...
    public partial class MainForm : Form
    {
        ...
        private void AddTaskButton_Click(object? sender, EventArgs e)
        {
            var task = new CyberTask
            {
                ...
                Description = "Turn on 2FA for important accounts.",
                ReminderText = "Reminder: In 3 days",
                IsCompleted = false
            };
            ...
            {
                AddBotMessage("Example task could not be saved to the database.");
                MessageBox.Show(ex.Message, "Database Error");
                return;
            }
            AddBotMessage("Example task added: Enable two-factor authentication.");
            AddActivity("Example task added: Enable two-factor authentication.");
        }
